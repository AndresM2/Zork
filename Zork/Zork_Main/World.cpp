...
World::World() {
	...
	// Crea los NPCs
	class NPC* ron = new class NPC("Juan", "He looks pretty fat.", "Stuck in this room? Check out the "+room2->GetName()+".", room1);
	class NPC* gilbert = new class NPC("Carlos", "He's a very tall man.", "It's a dangerous place to go alone, be careful!", room3);
